...
const Testimonials = () => {
  ...
  return <div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {testimonials.map((testimonial, index) => <div key={index} className="animate-fade-in-up" style={{
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <div className="bg-card p-8 rounded-lg shadow-soft hover-lift hover:shadow-large animate-fade-in-up" style={{
              animationDelay: "0s"
            }}>
                <div className="text-4xl font-bold text-secondary mb-2 glow-effect">25+</div>
              ...
              animationDelay: "0.1s"
                ...
                <div className="text-4xl font-bold text-secondary mb-2 glow-effect">300+</div>
              ...
              animationDelay: "0.2s"
                ...
                <div className="text-4xl font-bold text-secondary mb-2 glow-effect">14</div>
      ...
      {/* CTA Section */}
      <CTASection title="Ready to join our satisfied clients?" description="Experience the VMK difference. Book a free consultation to discuss how we can help your business thrive." primaryButtonText="Get Started Today" primaryButtonLink="/contact" secondaryButtonText="Learn About Our Services" secondaryButtonLink="/services" />
    </div>;
};
